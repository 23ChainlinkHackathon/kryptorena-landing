...
const Fray = () => {
  return (
    <div id="fray" className="w-auto overflow-hidden xsm:bg-[url('./img/fray.png')] lg:bg-[url('./img/fraylg.png')] md:bg-[url('./img/fraymd.png')] bg-cover  h-[438px] flex flex-col gap-5 justify-center items-center">
