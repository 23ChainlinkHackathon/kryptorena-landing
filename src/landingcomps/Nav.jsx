...
const Nav = () => {
  return (
    <div className="header lg:w-auto w-screen relative md:text-[24px] h-[60px] backdrop-blur-[12px] bg-black flex  items-center justify-between">
      <div className="flex gap-7 items-center">

          <div className="flex gap-3 justify-center  items-center">
            <img src={content} alt={content} className="h-[20px] left-3 w-[44px] relative " />
