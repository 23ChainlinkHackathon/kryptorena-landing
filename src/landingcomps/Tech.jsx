...
const Tech = () => {
  return (
    <div id="tech" className=" xl:flex-row xl:gap-[120px] xl:items-center overflow-hidden lg:w-auto w-screen xl:justify-center md:h-[950px] xl:h-[631.67px] h-[900px] lg:h-[600px] xl:bg-[url('./img/techxl.png')] xsm:bg-[url('./img/techmob1.png')] lg:bg-[url('./img/techxl.png')] lg:gap-0 lg:space-x-[-10px] bg-cover xsm:flex-col flex items-center gap-6 justify-center">
